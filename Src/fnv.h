...
*	 argument on the first call to either fnv_32_buf() or fnv_32_str().
*/
static Fnv32_t fnv_32_str(const char *str, Fnv32_t hval)
{
...
*/
static Fnv32_t fnv_32a_str(const char *str, Fnv32_t hval)
{
	const unsigned char *s = (const unsigned char *)str;	/* unsigned string */
...
*	 argument on the first call to either fnv_64_buf() or fnv_64_str().
*/
static Fnv64_t fnv_64_str(const char *str, Fnv64_t hval)
{
	const unsigned char *s = (const unsigned char *)str;	/* unsigned string */
